    ...
    >
      ...
      <div className="flex justify-center mb-2">
        <motion.button
          whileTap={{ scale: 0.94 }}
          onClick={onRestart}
          className="font-pixel text-[0.35rem] sm:text-7xs tracking-wider5 px-4 sm:px-6 py-2 sm:py-2.5 bg-bg-base text-accent border-2 border-accent shadow-[4px_4px_0px_var(--cyan-dim)] cursor-pointer flex items-center gap-2 sm:gap-2.5 hover:bg-accent hover:text-bg-base transition-colors duration-150"
        >
